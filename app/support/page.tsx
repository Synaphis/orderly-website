...
export const metadata: Metadata = {
  title: "Support",
  description: "Get help with Subly for iPhone."
};
      ...
      sections={[
        ...
        },
        {
          ...
          body: [
            ...
            "If a reminder appears wrong, check the store policy and the saved order date. Subly’s reminders are organizational prompts, not guarantees from the retailer.",
            "If a refund is late, use Subly’s notes and receipts to contact the store, carrier, or bank that controls the refund."
          ]
        },
        {
